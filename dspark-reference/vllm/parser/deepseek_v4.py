...
def deepseek_v4_config(thinking: bool = False) -> ParserEngineConfig:
    return ParserEngineConfig(
        ...
        transitions={
            ...
            # At long context the model often omits <｜DSML｜tool_calls> but still
            # emits a well-formed <｜DSML｜invoke ...> block. Without this edge the
            ...
            # Same recovery when the model starts a tool call before </think>.
