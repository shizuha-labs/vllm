...
#
# Run (recommended):
#   python -m vllm.vllm_flash_attn.cute.benchmark_flash_attention_fp8
#
# Notes:
...
from vllm.vllm_flash_attn.cute.benchmark import benchmark_forward
from vllm.vllm_flash_attn.cute.interface import _flash_attn_fwd as flash_attn_cute_fwd
